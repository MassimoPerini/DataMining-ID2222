...
import se.kth.jabeja.SimAnnhType;
...
public class CLI {
  ...
  @Option(name = "-simAnnhMode", usage = "Sim. annh mode (LIN or EXP)")
  private String simAnnhTypeInit = "LIN";
  private static SimAnnhType simAnnhMode = SimAnnhType.LIN;
